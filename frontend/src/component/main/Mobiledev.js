...
// things will change
        ...
        <div className="servicetype">
              ...
              <h3 className="serviceh3" id="supper">PERSONAL APPS<p>#100,000</p></h3>
        ...
        <h3 className="serviceh3" id="serviceHead">ECOMERCE APPS<p>#100,000</p></h3>
...
<p className="pack" id="red">comes with website</p>
<button className="hbutton" id="b2">Requst</button>
</div>  
</div>      
</div>
